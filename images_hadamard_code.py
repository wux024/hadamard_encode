...
def main():
    ...
    # Check if the optical field sizes are powers of two
    ...
    # Check if the sub-optical field sizes are powers of two
    ...
    for optical_field_size in optical_field_sizes:
        ...
        for split in dataset_splits:
            ...
            for image_path in image_paths:
                ...
                saved_hadamard_result = hadamard_result.reshape(optical_field_size, optical_field_size, channels)
